...
유저가 게임을 플레이 하고 있는 시점에 에셋을 로드해야 할 경우에는 비동기 로드(ASyncLoad)를 사용해 게임 플레이 도중 프레임 드랍이나 히칭(Hitching) 현상 등의 불쾌한 성능저하를 최소화하도록 설계했습니다.
...
<br/>
등 객체를 안전하게 유지할 수 있는 여러 방법을 배웠습니다.<br/>
